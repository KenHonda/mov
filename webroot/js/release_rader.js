...
window.onload = function() {
raderDraw("sample9", data_package, 0, "red");
>>>>>>> rebase前
};
...
addEvent(window,"load",function(){
  ...
  rc.draw(items, params);
=======
	raderDraw("sample11", data_package, 1, "#ff6600");
});
addEvent(window,"load",function(){
	raderDraw("sample14", data_package, 2, "navy");
});
addEvent(window,"load",function(){
	raderDraw("sample15", data_package, 3, "green");
>>>>>>> rebase前
});
